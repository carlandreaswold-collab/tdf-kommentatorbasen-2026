...
const VM_DATA = {
  ...
  historikk: {
    ...
    herrer_fellesstart: [
      ...
      { år:2016, sted:"Doha, QAT",                gull:"Peter Sagan (SVK)",        sølv:"Mark Cavendish (GBR)",      bronse:"Tom Boonen (BEL)",          norsk:"—" },
      ...
      { år:2021, sted:"Leuven, BEL",               gull:"Julian Alaphilippe (FRA)", sølv:"Dylan van Baarle (NED)",    bronse:"Michael Valgren (DEN)",     norsk:"—" },
      { år:2022, sted:"Wollongong, AUS",           gull:"Remco Evenepoel (BEL)",    sølv:"Christophe Laporte (FRA)",  bronse:"Michael Matthews (AUS)",    norsk:"—" },
      { år:2023, sted:"Glasgow, SCO",              gull:"Mathieu van der Poel (NED)",sølv:"Wout van Aert (BEL)",      bronse:"Tadej Pogačar (SLO)",       norsk:"—" },
      { år:2024, sted:"Zürich, SUI",               gull:"Tadej Pogačar (SLO)",      sølv:"Ben O'Connor (AUS)",        bronse:"Mathieu van der Poel (NED)",norsk:"—" },
    ...
    herrer_tempo: [
      ...
      { år:2017, sted:"Bergen, NOR 🇳🇴",           gull:"Tom Dumoulin (NED)",       sølv:"Primož Roglič (SLO)",       bronse:"Chris Froome (GBR)",        norsk:"—" },
      { år:2018, sted:"Innsbruck, AUT",             gull:"Rohan Dennis (AUS)",       sølv:"Tom Dumoulin (NED)",        bronse:"Jon Castroviejo (ESP)",     norsk:"—" },
      { år:2019, sted:"Harrogate, GBR",             gull:"Rohan Dennis (AUS)",       sølv:"Remco Evenepoel (BEL)",     bronse:"Filippo Ganna (ITA)",       norsk:"—" },
      { år:2020, sted:"Imola, ITA",                 gull:"Filippo Ganna (ITA)",      sølv:"Wout van Aert (BEL)",       bronse:"Stefan Küng (SUI)",         norsk:"—" },
      { år:2021, sted:"Leuven, BEL",                gull:"Filippo Ganna (ITA)",      sølv:"Wout van Aert (BEL)",       bronse:"Remco Evenepoel (BEL)",     norsk:"—" },
      { år:2022, sted:"Wollongong, AUS",            gull:"Tobias Foss 🇳🇴",         sølv:"Stefan Küng (SUI)",         bronse:"Remco Evenepoel (BEL)",     norsk:"🥇 GULL — Tobias Foss! Ingen ventet det!", norskFlagg:true },
      { år:2023, sted:"Glasgow, SCO",               gull:"Remco Evenepoel (BEL)",    sølv:"Filippo Ganna (ITA)",       bronse:"Josh Tarling (GBR)",        norsk:"—" },
      { år:2024, sted:"Zürich, SUI",                gull:"Remco Evenepoel (BEL)",    sølv:"Stefan Küng (SUI)",         bronse:"Edoardo Affini (ITA)",      norsk:"—" },
    ...
    kvinner_fellesstart: [
      ...
      { år:2016, sted:"Doha, QAT",                 gull:"Amalie Dideriksen (DEN)",  sølv:"Kirsten Wild (NED)",        bronse:"Lotta Henttala (FIN)",      norsk:"—" },
      { år:2017, sted:"Bergen, NOR 🇳🇴",           gull:"Chantal van den Broek-Blaak (NED)",sølv:"Katrin Garfoot (AUS)",      bronse:"Amalie Dideriksen (DEN)",   norsk:"—" },
      { år:2018, sted:"Innsbruck, AUT",             gull:"Anna van der Breggen (NED)",sølv:"Cecilie Uttrup Ludwig (DEN)",bronse:"Tatiana Guderzo (ITA)",     norsk:"—" },
      { år:2019, sted:"Harrogate, GBR",             gull:"Annemiek van Vleuten (NED)",sølv:"Anna van der Breggen (NED)",bronse:"Amanda Spratt (AUS)",       norsk:"—" },
      { år:2020, sted:"Imola, ITA",                 gull:"Anna van der Breggen (NED)",sølv:"Annemiek van Vleuten (NED)",bronse:"Elisa Longo Borghini (ITA)",norsk:"—" },
      { år:2021, sted:"Leuven, BEL",                gull:"Elisa Balsamo (ITA)",      sølv:"Marianne Vos (NED)",        bronse:"Katarzyna Niewiadoma (POL)",norsk:"—" },
      { år:2022, sted:"Wollongong, AUS",            gull:"Annemiek van Vleuten (NED)",sølv:"Lotte Kopecky (BEL)",      bronse:"Silvia Persico (ITA)",      norsk:"—" },
    ...
    kvinner_tempo: [
      ...
      { år:2017, sted:"Bergen, NOR 🇳🇴",           gull:"Annemiek van Vleuten (NED)",sølv:"Anna van der Breggen (NED)",bronse:"Amber Neben (USA)",         norsk:"—" },
      { år:2018, sted:"Innsbruck, AUT",             gull:"Annemiek van Vleuten (NED)",sølv:"Anna van der Breggen (NED)",bronse:"Ellen van Dijk (NED)",      norsk:"—" },
      { år:2019, sted:"Harrogate, GBR",             gull:"Chloe Dygert (USA)",       sølv:"Annemiek van Vleuten (NED)",bronse:"Anna van der Breggen (NED)",norsk:"—" },
      { år:2020, sted:"Imola, ITA",                 gull:"Anna van der Breggen (NED)",sølv:"Marlen Reusser (SUI)",       bronse:"Ellen van Dijk (NED)",     norsk:"—" },
      { år:2021, sted:"Leuven, BEL",                gull:"Ellen van Dijk (NED)",     sølv:"Marlen Reusser (SUI)",      bronse:"Lisa Brennauer (GER)",      norsk:"—" },
