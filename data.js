/* =============================================================
   ...
   Sist oppdatert: 2026-07-02  (offisielle startnumre (bibs) lagt inn for alle 184 ryttere. Navnefeil rettet: Jenno Berckmoes, Baptiste Veistroffer, Huub Artz, Liam Slock (alle LIN), Florian Vermeersch (UAE). Nye kortkort: Dillier #103, Planckaert #106 (APT), Harper #173, Howson #175, Meurisse #176 (PQ3).)
...
const TDF_DATA = {
  ...
  lag: [
    ...
    { kort:"VLB", navn:"Visma | Lease a Bike", land:"Nederland", farger:["#ffe500","#1a1a1a","#e30613"],
      ...
      ds:["Grischa Niermann", "Marc Reef", "Frans Maassen"],
    ...
    { kort:"RBH", navn:"Red Bull-BORA-hansgrohe", land:"Tyskland", farger:["#0c1640","#cc0000","#f5d000"],
      ...
      ds:["Patxi Vila", "Klaas Lodewyck", "Sven Vanthourenhout"],
    ...
    { kort:"LTK", navn:"Lidl-Trek", land:"USA", farger:["#0d1a3f","#d2002e","#ffffff"],
      ...
      ds:["Steven de Jongh", "Andy Schleck", "Grégory Rast"],
    ...
    { kort:"DEC", navn:"Decathlon CMA CGM", land:"Frankrike", farger:["#0046b9","#ffffff","#1d1d1b"],
      ...
      ds:["Luke Rowe", "Julien Jurdie", "Nicolas Guillé", "Mark Renshaw"],
    ...
    { kort:"IGD", navn:"Netcompany INEOS", land:"Storbr.", farger:["#1d1d1b","#c8102e","#0033a0"],
      ...
      ds:["Geraint Thomas", "Dario David Cioni", "Xabier Zandio"],
    ...
    { kort:"EFE", navn:"EF Education-EasyPost", land:"USA", farger:["#ec268f","#0d1b8f","#1d1d1b"],
      ...
      ds:["Charly Wegelius", "Juanma Garate", "Tom Southam"],
    ...
    { kort:"MOV", navn:"Movistar Team", land:"Spania", farger:["#041e5f","#00a6a3","#ffffff"],
      ...
      ds:["José Luis Arrieta", "Pablo Lastras"],
    ...
    { kort:"SOQ", navn:"Soudal Quick-Step", land:"Belgia", farger:["#0a2a6b","#ffffff","#9b9b9b"],
      ...
      ds:["Tom Steels", "Davide Bramati", "Iljo Keisse"],
    ...
    { kort:"TBV", navn:"Bahrain Victorious", land:"Bahrain", farger:["#9d1b30","#0a1342","#e30613"],
      ...
      ds:["Gorazd Štangelj", "Roman Kreuziger"],
    ...
    { kort:"PIC", navn:"Team Picnic PostNL", land:"Nederland", farger:["#e2001a","#0a1342","#ffffff"],
      leder:"—", nr:211,
      ds:["Rudi Kemna", "Roy Curvers", "Pim Ligthart"],
    ...
    { kort:"LIN", navn:"Lotto Intermarché", land:"Belgia", farger:["#d2002e","#1d1d1b","#ffd200"],
      ...
      ds:["Mario Aerts", "Pieter Vanspeybroeck", "Maxime Bouet"],
    ...
    { kort:"UNO", navn:"Uno-X Mobility", land:"Norge", farger:["#ff5a00","#3a2a1a","#ffffff"],
      ...
      ds:["Gabriel Rasch", "Stig Kristiansen", "Christian Andersen"],
    ...
    { kort:"COF", navn:"Cofidis", land:"Frankrike", farger:["#d2002e","#ffffff","#1d1d1b"],
      leder:"—", nr:161,
      ds:["Bingen Fernández", "Sébastien Hinault", "Roberto Damiani"],
    ...
    { kort:"TUD", navn:"Tudor Pro Cycling Team", land:"Sveits", farger:["#c8102e","#1d1d1b","#ffffff"],
      ...
      ds:["Ricardo Scheidecker", "Addy Engels"],
    ...
    { kort:"JAY", navn:"Team Jayco AlUla", land:"Australia", farger:["#002d62","#e87722","#ffffff"],
      ...
      ds:["Mathew Hayman", "Steve Cummings", "Valerio Piva"],
    ...
    { kort:"TOT", navn:"TotalEnergies", land:"Frankrike", farger:["#c8102e","#ff6a00","#ffffff"],
      ...
      ds:["Benoît Genauzeau", "Cyril Lemoine", "Romain Sicard"],
  ...
  ryttere: [
    ...
    /* ---- NORSK INTERESSE ---- */
    { navn:"Per Strand Hagenes", lag:"VLB", land:"Norge", alder:22, rolle:"Allrounder / hjelper", nr:15, foto:"", norsk:true,
    ...
    /* ---- NETCOMPANY INEOS ---- */
    { navn:"Egan Bernal", lag:"IGD", land:"Colombia", alder:28, rolle:"Sammenlagt / klatrer", nr:81, foto:"",
    ...
    { navn:"Tobias Foss", lag:"IGD", land:"Norge", alder:27, rolle:"Tempo / allrounder", nr:83, foto:"", norsk:true,
      ...
      historie:"Norsk tempoallrounder. VERDENSMESTER i enkeltstart 2022 i Wollongong — ett av Norges største sykkelgull noensinne. Også U23-verdensmester 2019. Syklet for Jumbo-Visma/Visma i mange år — nå på INEOS. NORSK TdF-rytter 2026!" },
    { navn:"Kévin Vauquelin", lag:"IGD", land:"Frankrike", alder:25, rolle:"Klatrer / etappejeger", nr:88, foto:"",
    ...
    { navn:"Joshua Tarling", lag:"IGD", land:"Wales", alder:22, rolle:"Tempo-spesialist", nr:87, foto:"",
      ...
      form:"En av verdens beste unge temposyklister. Sammen med Ganna = INEOS' todubber på tempoetapper. Bare 22 år — en fremtidig Grand Tour-trussel.",
      skade:"Ingen kjente skader.",
      historie:"Walisisk tempo-under. VM-sølv 2024 i enkeltstart. INEOS har nå TO verdensklasse-temposyklister til etappe 16." },
