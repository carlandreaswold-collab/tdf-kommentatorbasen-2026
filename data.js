...
const TDF_DATA = {
  ...
  ryttere: [
    ...
    { navn:"Paul Seixas", lag:"DEC", land:"Frankrike", alder:19, rolle:"Sammenlagt (talent)", nr:51, foto:"",
    ...
    { navn:"Juan Ayuso", lag:"LTK", land:"Spania", alder:23, rolle:"Sammenlagt", nr:31, foto:"",
    ...
    { navn:"Cian Uijtdebroeks", lag:"MOV", land:"Belgia", alder:23, rolle:"Sammenlagt", nr:141, foto:"",
    ...
    { navn:"Tom Pidcock", lag:"PQ3", land:"Storbr.", alder:26, rolle:"Sammenlagt / brudd", nr:171, foto:"",
    ...
    { navn:"Richard Carapaz", lag:"EFE", land:"Ecuador", alder:33, rolle:"Sammenlagt", nr:41, foto:"",
    ...
    { navn:"Florian Lipowitz", lag:"RBH", land:"Tyskland", alder:25, rolle:"Sammenlagt", nr:25, foto:"",
    ...
    { navn:"Lennert Van Eetvelt", lag:"LIN", land:"Belgia", alder:23, rolle:"Sammenlagt", nr:156, foto:"",
    ...
    /* ---- KLASSIKER/SPURT ---- */
    { navn:"Mathieu van der Poel", lag:"APT", land:"Nederland", alder:31, rolle:"Klassiker / spurt / brudd", nr:101, foto:"",
    ...
    { navn:"Jasper Philipsen", lag:"APT", land:"Belgia", alder:27, rolle:"Spurt", nr:105, foto:"",
    ...
    { navn:"Mads Pedersen", lag:"LTK", land:"Danmark", alder:29, rolle:"Spurt / klassiker", nr:33, foto:"",
    ...
    { navn:"Biniam Girmay", lag:"NSN", land:"Eritrea", alder:24, rolle:"Spurt / klassiker", nr:131, foto:"",
    ...
    { navn:"Julian Alaphilippe", lag:"TUD", land:"Frankrike", alder:33, rolle:"Klassiker / brudd", nr:191, foto:"",
    ...
    { navn:"Ben Healy", lag:"EFE", land:"Irland", alder:24, rolle:"Etappejeger / klatrer", nr:44, foto:"",
    ...
    /* ---- NORSK INTERESSE ---- */
    { navn:"Tobias Halland Johannessen", lag:"UNO", land:"Norge", alder:26, rolle:"Sammenlagt", nr:121, foto:"", norsk:true,
    ...
    { navn:"Jonas Abrahamsen", lag:"UNO", land:"Norge", alder:30, rolle:"Brudd / klatring", nr:122, foto:"", norsk:true,
    ...
    { navn:"Søren Wærenskjold", lag:"UNO", land:"Norge", alder:25, rolle:"Spurt / tempo / klassiker", nr:128, foto:"", norsk:true,
    ...
    { navn:"Torstein Træen", lag:"UNO", land:"Norge", alder:30, rolle:"Klatrer / hjelper", nr:127, foto:"", norsk:true,
    ...
    { navn:"Anders Skaarseth", lag:"UNO", land:"Norge", alder:27, rolle:"Hjelper / allrounder", nr:126, foto:"", norsk:true,
    ...
    { navn:"Magnus Cort", lag:"UNO", land:"Danmark", alder:32, rolle:"Etappejeger / spurt", nr:124, foto:"",
    ...
    { navn:"Matteo Jorgenson", lag:"VLB", land:"USA", alder:26, rolle:"Sammenlagt / hjelper", nr:16, foto:"",
    ...
    /* ---- NORSK INTERESSE ---- */
    { navn:"Per Strand Hagenes", lag:"VLB", land:"Norge", alder:24, rolle:"Allrounder / hjelper", nr:15, foto:"", norsk:true,
    ...
    /* ---- UAE TEAM EMIRATES ---- */
    { navn:"Isaac Del Toro", lag:"UAE", land:"Mexico", alder:22, rolle:"Sammenlagt / klatrer", nr:2, foto:"",
    ...
    { navn:"Brandon McNulty", lag:"UAE", land:"USA", alder:27, rolle:"Allrounder / tempo / hjelper", nr:4, foto:"",
    ...
    { navn:"Nils Politt", lag:"UAE", land:"Tyskland", alder:31, rolle:"Klassiker / brudd", nr:5, foto:"",
    ...
    { navn:"Florian Vermeersch", lag:"UAE", land:"Belgia", alder:31, rolle:"Klassiker / brudd", nr:6, foto:"",
    ...
    { navn:"Adam Yates", lag:"UAE", land:"Storbr.", alder:32, rolle:"Klatrer / hjelper", nr:8, foto:"",
    ...
    { navn:"Felix Grossschartner", lag:"UAE", land:"Østerrike", alder:31, rolle:"Allrounder / hjelper", nr:3, foto:"",
    ...
    { navn:"Tim Wellens", lag:"UAE", land:"Belgia", alder:33, rolle:"Brudd / puncheur / klatrer", nr:7, foto:"",
    ...
    /* ---- VISMA | LEASE A BIKE ---- */
    { navn:"Davide Piganzoli", lag:"VLB", land:"Italia", alder:24, rolle:"Klatrer / GC-hjelper", nr:18, foto:"",
    ...
    { navn:"Sepp Kuss", lag:"VLB", land:"USA", alder:30, rolle:"Klatrer / hjelper", nr:17, foto:"",
    ...
    { navn:"Bruno Armirail", lag:"VLB", land:"Frankrike", alder:31, rolle:"Hjelper / tempo", nr:13, foto:"",
    ...
    { navn:"Victor Campenaerts", lag:"VLB", land:"Belgia", alder:33, rolle:"Tempo / hjelper", nr:14, foto:"",
    ...
    { navn:"Edoardo Affini", lag:"VLB", land:"Italia", alder:29, rolle:"Tempo / hjelper", nr:12, foto:"",
    ...
    { navn:"Maxim Van Gils", lag:"RBH", land:"Belgia", alder:26, rolle:"Klatrer / puncheur", nr:28, foto:"",
    ...
    { navn:"Jai Hindley", lag:"RBH", land:"Australia", alder:29, rolle:"Klatrer / GC", nr:24, foto:"",
    ...
    { navn:"Mattia Cattaneo", lag:"RBH", land:"Italia", alder:32, rolle:"Allrounder / hjelper", nr:22, foto:"",
    ...
    { navn:"Nico Denz", lag:"RBH", land:"Tyskland", alder:31, rolle:"Allrounder / etappejeger", nr:23, foto:"",
    ...
    { navn:"Jan Tratnik", lag:"RBH", land:"Slovenia", alder:34, rolle:"Hjelper / allrounder", nr:26, foto:"",
    ...
    { navn:"Tim van Dijke", lag:"RBH", land:"Nederland", alder:24, rolle:"Allrounder / spurt", nr:27, foto:"",
    ...
    /* ---- LIDL–TREK ---- */
    { navn:"Mattias Skjelmose", lag:"LTK", land:"Danmark", alder:24, rolle:"Sammenlagt / klatrer", nr:35, foto:"",
    ...
    { navn:"Quinn Simmons", lag:"LTK", land:"USA", alder:24, rolle:"Puncheur / allrounder", nr:34, foto:"",
    ...
    { navn:"Carlos Verona", lag:"LTK", land:"Spania", alder:32, rolle:"Klatrer / hjelper", nr:38, foto:"",
    ...
    { navn:"Mathias Vacek", lag:"LTK", land:"Tsjekkia", alder:23, rolle:"Allrounder / klatrer", nr:37, foto:"",
    ...
    { navn:"Toms Skujiņš", lag:"LTK", land:"Latvia", alder:34, rolle:"Brudd / etappejeger", nr:36, foto:"",
    ...
    { navn:"Derek Gee-West", lag:"LTK", land:"Ukjent", alder:null, rolle:"Allrounder / hjelper", nr:32, foto:"",
    ...
    /* ---- DECATHLON CMA CGM ---- */
    { navn:"Tiesj Benoot", lag:"DEC", land:"Belgia", alder:31, rolle:"Klassiker / allrounder", nr:52, foto:"",
    ...
    { navn:"Daan Hoole", lag:"DEC", land:"Nederland", alder:26, rolle:"Allrounder / tempo", nr:54, foto:"",
    ...
    { navn:"Aurélien Paret-Peintre", lag:"DEC", land:"Frankrike", alder:27, rolle:"Klatrer / etappejeger", nr:56, foto:"",
    ...
    { navn:"Nicolas Prodhomme", lag:"DEC", land:"Frankrike", alder:28, rolle:"Hjelper / klatrer", nr:57, foto:"",
    ...
    { navn:"Olav Kooij", lag:"DEC", land:"Nederland", alder:25, rolle:"Spurt", nr:55, foto:"",
    ...
    { navn:"Cees Bol", lag:"DEC", land:"Nederland", alder:30, rolle:"Allrounder / spurt", nr:53, foto:"",
    ...
    { navn:"Tim Marsman", lag:"APT", land:"Nederland", alder:31, rolle:"Hjelper / allrounder", nr:104, foto:"",
    ...
    { navn:"Ramses Debruyne", lag:"APT", land:"Belgia", alder:27, rolle:"Hjelper / klatrer", nr:102, foto:"",
    ...
    { navn:"Silvan Dillier", lag:"APT", land:"Sveits", alder:33, rolle:"Klassiker / hjelper", nr:103, foto:"",
    ...
    { navn:"Edward Planckaert", lag:"APT", land:"Belgia", alder:31, rolle:"Spurt / hjelper", nr:106, foto:"",
    ...
    /* ---- NETCOMPANY INEOS ---- */
    { navn:"Egan Bernal", lag:"IGD", land:"Colombia", alder:29, rolle:"Sammenlagt / klatrer", nr:81, foto:"",
    ...
    { navn:"Thymen Arensman", lag:"IGD", land:"Nederland", alder:25, rolle:"Klatrer / GC", nr:82, foto:"",
    ...
    { navn:"Filippo Ganna", lag:"IGD", land:"Italia", alder:29, rolle:"Tempo-spesialist", nr:84, foto:"",
    ...
    { navn:"Tobias Foss", lag:"IGD", land:"Norge", alder:27, rolle:"Tempo / allrounder", nr:83, foto:"", norsk:true,
    ...
    { navn:"Kévin Vauquelin", lag:"IGD", land:"Frankrike", alder:25, rolle:"Klatrer / etappejeger / GC", nr:88, foto:"",
    ...
    { navn:"Michał Kwiatkowski", lag:"IGD", land:"Polen", alder:34, rolle:"Klassiker / allrounder / hjelper", nr:86, foto:"",
    ...
    { navn:"Dorian Godon", lag:"IGD", land:"Frankrike", alder:27, rolle:"Klatrer / hjelper", nr:85, foto:"",
    ...
    { navn:"Joshua Tarling", lag:"IGD", land:"Wales", alder:22, rolle:"Tempo-spesialist", nr:87, foto:"",
    ...
    { navn:"Kasper Asgreen", lag:"EFE", land:"Danmark", alder:31, rolle:"Klassiker / tempo", nr:42, foto:"",
    ...
    { navn:"Alex Baudin", lag:"EFE", land:"Frankrike", alder:25, rolle:"Klatrer / etappejeger", nr:43, foto:"",
    ...
    { navn:"Sean Quinn", lag:"EFE", land:"USA", alder:30, rolle:"Hjelper / allrounder", nr:45, foto:"",
    ...
    { navn:"Georg Steinhauser", lag:"EFE", land:"Tyskland", alder:24, rolle:"Klatrer / brudd", nr:46, foto:"",
    ...
    { navn:"Max Walker", lag:"EFE", land:"Australia", alder:25, rolle:"Hjelper / allrounder", nr:48, foto:"",
      meritter:"Allrounder",
      form:"Australsk hjelper for EF i Tour de France 2026.",
      historie:"Ung australsk bidragsyter. Bred profil." },
    { navn:"Michael Valgren", lag:"EFE", land:"Danmark", alder:32, rolle:"Klassiker / hjelper", nr:47, foto:"",
    ...
    /* ---- GROUPAMA–FDJ UNITED ---- */
    { navn:"Guillaume Martin", lag:"GFC", land:"Frankrike", alder:33, rolle:"Sammenlagt / klatrer", nr:186, foto:"",
    ...
    { navn:"Romain Grégoire", lag:"GFC", land:"Frankrike", alder:22, rolle:"Allrounder / klatrer", nr:181, foto:"",
    ...
    { navn:"Clément Berthet", lag:"GFC", land:"Frankrike", alder:27, rolle:"Klatrer / hjelper", nr:182, foto:"",
    ...
    { navn:"Lorenzo Germani", lag:"GFC", land:"Italia", alder:24, rolle:"Klatrer / hjelper", nr:185, foto:"",
    ...
    { navn:"Quentin Pacher", lag:"GFC", land:"Frankrike", alder:32, rolle:"Klatrer / brudd", nr:187, foto:"",
    ...
    { navn:"Clément Russo", lag:"GFC", land:"Frankrike", alder:30, rolle:"Hjelper / allrounder", nr:188, foto:"",
    ...
    { navn:"Ewen Costiou", lag:"GFC", land:"Frankrike", alder:27, rolle:"Spurt / allrounder", nr:184, foto:"",
    ...
    { navn:"Clément Braz Afonso", lag:"GFC", land:"Frankrike", alder:25, rolle:"Hjelper / klatrer", nr:183, foto:"",
      meritter:"Ung hjelper",
      form:"Ung hjelper for FDJ i Tour de France 2026.",
      historie:"Ungt franskt talent på FDJ-laget." },

    /* ---- MOVISTAR TEAM ---- */
    { navn:"Pablo Castrillo", lag:"MOV", land:"Spania", alder:25, rolle:"Klatrer / hjelper", nr:142, foto:"",
      meritter:"Solid klatrer",
      form:"Klatrehjelper for Uijtdebroeks.",
      historie:"Spansk klatrer for Movistar." },
    { navn:"Georg Hessmann", lag:"MOV", land:"Tyskland", alder:25, rolle:"Allrounder / hjelper", nr:145, foto:"",
    ...
    { navn:"Carlos Rubio", lag:"MOV", land:"Spania", alder:24, rolle:"Klatrer / hjelper", nr:148, foto:"",
      ...
      historie:"Spansk klatrer for Movistar." },
    { navn:"Nelson Oliveira", lag:"MOV", land:"Portugal", alder:34, rolle:"Hjelper / allrounder", nr:146, foto:"",
    ...
    { navn:"Jefferson Cepeda", lag:"MOV", land:"Ecuador", alder:27, rolle:"Klatrer / hjelper", nr:143, foto:"",
    ...
    { navn:"Javier Romo", lag:"MOV", land:"Spania", alder:25, rolle:"Klatrer / hjelper", nr:147, foto:"",
    ...
    { navn:"Raúl García Pierna", lag:"MOV", land:"Spania", alder:23, rolle:"Klatrer / hjelper", nr:144, foto:"",
    ...
    /* ---- SOUDAL–QUICK-STEP ---- */
    { navn:"Dylan van Baarle", lag:"SOQ", land:"Nederland", alder:33, rolle:"Klassiker / allrounder", nr:95, foto:"",
    ...
    { navn:"Tim Merlier", lag:"SOQ", land:"Belgia", alder:33, rolle:"Spurt", nr:91, foto:"",
    ...
    { navn:"Valentin Paret-Peintre", lag:"SOQ", land:"Frankrike", alder:28, rolle:"Klatrer / etappejeger", nr:93, foto:"",
    ...
    { navn:"Bert Van Lerberghe", lag:"SOQ", land:"Belgia", alder:31, rolle:"Klassiker / brudd", nr:96, foto:"",
    ...
    { navn:"Jasper Stuyven", lag:"SOQ", land:"Belgia", alder:33, rolle:"Klassiker / etappejeger", nr:94, foto:"",
    ...
    { navn:"Louis Vervaeke", lag:"SOQ", land:"Belgia", alder:31, rolle:"Hjelper / klatrer", nr:98, foto:"",
    ...
    { navn:"Pascal Eenkhoorn", lag:"SOQ", land:"Nederland", alder:28, rolle:"Allrounder / etappejeger", nr:92, foto:"",
      meritter:"Etappeseirer, sterk allrounder",
    ...
    { navn:"Ilan Van Wilder", lag:"SOQ", land:"Belgia", alder:24, rolle:"Klatrer / allrounder", nr:97, foto:"",
    ...
    /* ---- BAHRAIN VICTORIOUS ---- */
    { navn:"Lenny Martínez", lag:"TBV", land:"Frankrike", alder:23, rolle:"Klatrer / GC-talent", nr:71, foto:"",
    ...
    { navn:"Matej Mohorič", lag:"TBV", land:"Slovenia", alder:31, rolle:"Brudd / klassiker", nr:75, foto:"",
    ...
    { navn:"Antonio Tiberi", lag:"TBV", land:"Italia", alder:24, rolle:"Klatrer / GC-talent", nr:77, foto:"",
    ...
    { navn:"Phil Bauhaus", lag:"TBV", land:"Tyskland", alder:28, rolle:"Spurt", nr:72, foto:"",
    ...
    { navn:"Damiano Caruso", lag:"TBV", land:"Italia", alder:37, rolle:"Klatrer / GC-hjelper", nr:73, foto:"",
    ...
    { navn:"Kamil Gradek", lag:"TBV", land:"Polen", alder:35, rolle:"Hjelper / road captain", nr:74, foto:"",
    ...
    { navn:"Vlad Van Mechelen", lag:"TBV", land:"Belgia", alder:22, rolle:"Spurt / hjelper", nr:78, foto:"",
    ...
    { navn:"Robert Stannard", lag:"TBV", land:"Australia", alder:27, rolle:"Allrounder / hjelper", nr:76, foto:"",
    ...
    /* ---- TEAM PICNIC POSTNL ---- */
    { navn:"van den Broek", lag:"PIC", land:"Nederland", alder:28, rolle:"Allrounder / hjelper", nr:218, foto:"",
      meritter:"Allrounder",
      form:"Nederlandsk hjelper for Picnic PostNL.",
      historie:"Nederlandsk bidragsyter i Tour de France 2026." },
    { navn:"Warren Barguil", lag:"PIC", land:"Frankrike", alder:35, rolle:"Klatrer / etappejeger", nr:211, foto:"",
    ...
    { navn:"Lars van den Berg", lag:"PIC", land:"Nederland", alder:26, rolle:"Allrounder / spurt", nr:217, foto:"",
      meritter:"Etappeseirer, allrounder",
      form:"Nederlandsk allrounder for Picnic PostNL.",
      historie:"Sterk allrounder. Kan spurte på kuperte avslutninger." },
    { navn:"Pavel Bittner", lag:"PIC", land:"Tsjekkia", alder:23, rolle:"Spurt", nr:213, foto:"",
    ...
    { navn:"Robbe Dhondt", lag:"PIC", land:"Belgia", alder:25, rolle:"Klatrer / hjelper", nr:215, foto:"",
      meritter:"Lovende klatrer",
    ...
    { navn:"Niklas Märkl", lag:"PIC", land:"Tyskland", alder:24, rolle:"Klatrer / allrounder", nr:216, foto:"",
      meritter:"Ung lovende klatrer",
    ...
    { navn:"Frits Biesterbos", lag:"PIC", land:"Nederland", alder:24, rolle:"Hjelper / allrounder", nr:212, foto:"",
    ...
    { navn:"John Degenkolb", lag:"PIC", land:"Tyskland", alder:36, rolle:"Klassiker / spurt", nr:214, foto:"",
    ...
    /* ---- LOTTO–INTERMARCHÉ ---- */
    { navn:"Arnaud De Lie", lag:"LIN", land:"Belgia", alder:23, rolle:"Spurt / puncheur", nr:151, foto:"",
    ...
    { navn:"Georg Zimmermann", lag:"LIN", land:"Tyskland", alder:28, rolle:"Klatrer / etappejeger", nr:158, foto:"",
    ...
    { navn:"Jenno Berckmoes", lag:"LIN", land:"Belgia", alder:24, rolle:"Klatrer / hjelper", nr:153, foto:"",
      meritter:"Lovende klatrer",
      form:"Ung klatrehjelper for Van Eetvelt.",
      historie:"Ung belgisk klatrer i Lotto-troppen." },
    { navn:"Baptiste Veistroffer", lag:"LIN", land:"Frankrike", alder:25, rolle:"Hjelper", nr:157, foto:"",
      meritter:"Solid hjelper",
      form:"Bidragsyter for Lotto.",
      historie:"Fransk hjelper for Lotto-Intermarché." },
    { navn:"Huub Artz", lag:"LIN", land:"Belgia", alder:24, rolle:"Hjelper / allrounder", nr:152, foto:"",
      meritter:"Allrounder",
      form:"Belgisk hjelper for Lotto-Intermarché.",
      historie:"Ung belgisk bidragsyter i Tour de France 2026." },
    { navn:"Lars Craps", lag:"LIN", land:"Belgia", alder:23, rolle:"Klatrer / hjelper", nr:154, foto:"",
      meritter:"Ung lovende klatrer",
      form:"Ung belgisk klatrer. Hjelper Van Eetvelt i fjellene.",
      historie:"Talentfull ung belgier. Debuterer i Tour de France 2026." },
    { navn:"Liam Slock", lag:"LIN", land:"Nederland", alder:23, rolle:"Klatrer / hjelper", nr:155, foto:"",
    ...
    /* ---- NSN CYCLING TEAM ---- */
    { navn:"Tom Van Asbroeck", lag:"NSN", land:"Belgia", alder:33, rolle:"Klassiker / allrounder", nr:138, foto:"",
    ...
    { navn:"Marco Frigo", lag:"NSN", land:"Italia", alder:25, rolle:"Klatrer / etappejeger", nr:134, foto:"",
      meritter:"Lovende italiensk klatrer",
    ...
    { navn:"Matîs Louvel", lag:"NSN", land:"Frankrike", alder:24, rolle:"Spurt / allrounder", nr:135, foto:"",
      meritter:"Etappeseirer, ung spurter",
    ...
    { navn:"Krists Neilands", lag:"NSN", land:"Latvia", alder:32, rolle:"Allrounder / brudd", nr:136, foto:"",
    ...
    { navn:"George Bennett", lag:"NSN", land:"New Zealand", alder:36, rolle:"Klatrer / GC-hjelper", nr:133, foto:"",
    ...
    { navn:"Lewis Askey", lag:"NSN", land:"Storbr.", alder:23, rolle:"Klatrer / allrounder", nr:132, foto:"",
    ...
    { navn:"Jake Stewart", lag:"NSN", land:"Storbr.", alder:25, rolle:"Spurt / puncheur", nr:137, foto:"",
    ...
    { navn:"Anders Johannessen", lag:"UNO", land:"Norge", alder:26, rolle:"Klatrer / hjelper", nr:125, foto:"", norsk:true,
    ...
    /* ---- XDS ASTANA TEAM ---- */
    { navn:"Sergio Higuita", lag:"AST", land:"Colombia", alder:29, rolle:"Klatrer / GC", nr:61, foto:"",
    ...
    { navn:"Harold Tejada", lag:"AST", land:"Colombia", alder:29, rolle:"Klatrer / hjelper", nr:65, foto:"",
    ...
    { navn:"Mike Teunissen", lag:"AST", land:"Nederland", alder:33, rolle:"Klassiker / allrounder", nr:66, foto:"",
    ...
    { navn:"Davide Ballerini", lag:"AST", land:"Italia", alder:30, rolle:"Klassiker / spurt", nr:62, foto:"",
    ...
    { navn:"Max Kanter", lag:"AST", land:"Tyskland", alder:28, rolle:"Spurt", nr:64, foto:"",
    ...
    { navn:"Aaron Gate", lag:"AST", land:"New Zealand", alder:35, rolle:"Allrounder / temposjålist", nr:63, foto:"",
    ...
    { navn:"Simone Velasco", lag:"AST", land:"Italia", alder:30, rolle:"Etappejeger / brudd", nr:67, foto:"",
    ...
    { navn:"Nicolas Vinokurov", lag:"AST", land:"Kasakhstan", alder:25, rolle:"Klatrer / allrounder", nr:68, foto:"",
    ...
    /* ---- COFIDIS ---- */
    { navn:"Alex Aranburu", lag:"COF", land:"Spania", alder:30, rolle:"Puncheur / klassiker", nr:163, foto:"",
    ...
    { navn:"Ion Izagirre", lag:"COF", land:"Spania", alder:36, rolle:"Etappejeger / klatrer", nr:161, foto:"",
    ...
    { navn:"Milan Fretin", lag:"COF", land:"Belgia", alder:24, rolle:"Spurt / hjelper", nr:165, foto:"",
      meritter:"Ung belgisk spurter",
    ...
    { navn:"Alex Kirsch", lag:"COF", land:"Luxemburg", alder:33, rolle:"Hjelper / allrounder", nr:166, foto:"",
    ...
    { navn:"Hugo Page", lag:"COF", land:"Frankrike", alder:24, rolle:"Klatrer / allrounder", nr:167, foto:"",
    ...
    { navn:"Bert Allegaert", lag:"COF", land:"Belgia", alder:29, rolle:"Klassiker / hjelper", nr:162, foto:"",
    ...
    { navn:"Jenthe Biermans", lag:"COF", land:"Belgia", alder:30, rolle:"Klassiker / hjelper", nr:164, foto:"",
      meritter:"Etappeseirer, klassikerspesialist",
    ...
    { navn:"Benjamin Thomas", lag:"COF", land:"Frankrike", alder:32, rolle:"Hjelper / allrounder", nr:168, foto:"",
    ...
    /* ---- TUDOR PRO CYCLING ---- */
    { navn:"Michael Storer", lag:"TUD", land:"Australia", alder:28, rolle:"Klatrer / etappejeger", nr:196, foto:"",
    ...
    { navn:"Matteo Trentin", lag:"TUD", land:"Italia", alder:36, rolle:"Klassiker / etappejeger", nr:197, foto:"",
    ...
    { navn:"Nick Pluimers", lag:"TUD", land:"Nederland", alder:25, rolle:"Klatrer / allrounder", nr:195, foto:"",
      meritter:"Ung lovende klatrer",
      form:"Nederlandsk klatrer for Tudor.",
      historie:"Ung talent i Tudor-troppen." },
    { navn:"Arvid de Kleijn", lag:"TUD", land:"Nederland", alder:27, rolle:"Spurt", nr:192, foto:"",
      meritter:"Etappeseirer, sterk spurter",
    ...
    { navn:"Marco Haller", lag:"TUD", land:"Østerrike", alder:34, rolle:"Hjelper / road captain", nr:193, foto:"",
    ...
    { navn:"Marc Hirschi", lag:"TUD", land:"Sveits", alder:27, rolle:"Klassiker / klatrer / etappejeger", nr:194, foto:"",
    ...
    { navn:"Yannis Voisard", lag:"TUD", land:"Sveits", alder:23, rolle:"Klatrer / allrounder", nr:198, foto:"",
    ...
    /* ---- PINARELLO–Q36.5 ---- */
    { navn:"Xabier Azparren", lag:"PQ3", land:"Spania", alder:25, rolle:"Klatrer / allrounder", nr:172, foto:"",
      meritter:"Lovende klatrer",
      form:"Spansk klatrer for Pinarello-Q36.5.",
      historie:"Ung spansk klatrer. Hjelper Pidcock i fjellene." },
    { navn:"Chris Harper", lag:"PQ3", land:"Australia", alder:31, rolle:"Allrounder / hjelper", nr:173, foto:"",
    ...
    { navn:"Quinten Hermans", lag:"PQ3", land:"Belgia", alder:30, rolle:"Puncheur / allrounder", nr:174, foto:"",
    ...
    { navn:"Damien Howson", lag:"PQ3", land:"Australia", alder:31, rolle:"Klatrer / GC-hjelper", nr:175, foto:"",
    ...
    { navn:"Xandro Meurisse", lag:"PQ3", land:"Belgia", alder:32, rolle:"Klatrer / brudd", nr:176, foto:"",
    ...
    { navn:"Brent Van Moer", lag:"PQ3", land:"Belgia", alder:27, rolle:"Brudd / allrounder", nr:177, foto:"",
    ...
    { navn:"Fred Wright", lag:"PQ3", land:"Storbr.", alder:25, rolle:"Allrounder / brudd", nr:178, foto:"",
    ...
    /* ---- TEAM JAYCO ALULA ---- */
    { navn:"Luke Durbridge", lag:"JAY", land:"Australia", alder:36, rolle:"Tempo / allrounder", nr:113, foto:"",
    ...
    { navn:"Felix Engelhardt", lag:"JAY", land:"Tyskland", alder:25, rolle:"Klatrer / allrounder", nr:114, foto:"",
    ...
    { navn:"Kelland O'Brien", lag:"JAY", land:"Australia", alder:25, rolle:"Allrounder / hjelper", nr:116, foto:"",
      meritter:"Etappeseirer, allrounder",
    ...
    { navn:"Michael Matthews", lag:"JAY", land:"Australia", alder:35, rolle:"Klassiker / spurt", nr:115, foto:"",
    ...
    { navn:"Ben O'Connor", lag:"JAY", land:"Australia", alder:30, rolle:"Klatrer / GC", nr:111, foto:"",
    ...
    { navn:"Luke Plapp", lag:"JAY", land:"Australia", alder:24, rolle:"Allrounder / tempo / GC-talent", nr:117, foto:"",
      meritter:"Sterk allrounder, temposterk",
    ...
    { navn:"Pascal Ackermann", lag:"JAY", land:"Tyskland", alder:31, rolle:"Spurt", nr:112, foto:"",
    ...
    { navn:"Mauro Schmid", lag:"JAY", land:"Sveits", alder:26, rolle:"Allrounder / brudd", nr:118, foto:"",
    ...
    /* ---- TOTALENERGIES ---- */
    { navn:"Anthony Turgis", lag:"TOT", land:"Frankrike", alder:31, rolle:"Etappejeger / puncheur", nr:207, foto:"",
    ...
    { navn:"Alexys Breuillard", lag:"TOT", land:"Frankrike", alder:27, rolle:"Hjelper", nr:202, foto:"",
      meritter:"Solid hjelper",
      form:"Bidragsyter for TotalEnergies.",
      historie:"Fransk hjelper for TotalEnergies." },
    { navn:"Jordan Jegat", lag:"TOT", land:"Frankrike", alder:25, rolle:"Hjelper / talent", nr:201, foto:"",
      meritter:"Ung talent",
    ...
    { navn:"Joris Delbove", lag:"TOT", land:"Frankrike", alder:25, rolle:"Spurt / hjelper", nr:203, foto:"",
    ...
    { navn:"Mattéo Vercher", lag:"TOT", land:"Frankrike", alder:27, rolle:"Etappejeger / puncheur", nr:208, foto:"",
    ...
    { navn:"Mathis Le Berre", lag:"TOT", land:"Frankrike", alder:24, rolle:"Hjelper / klatrer", nr:206, foto:"",
    ...
    { navn:"Thibault Guernalec", lag:"TOT", land:"Frankrike", alder:25, rolle:"Klatrer / hjelper", nr:205, foto:"",
      meritter:"Klatrer",
    ...
    { navn:"Alexandre Delettre", lag:"TOT", land:"Frankrike", alder:26, rolle:"Hjelper / allrounder", nr:204, foto:"",
      meritter:"Allrounder",
      form:"Hjelper for TotalEnergies. Bred profil.",
      historie:"Fransk hjelper og bidragsyter for TotalEnergies." },

    /* ---- CAJA RURAL–SEGUROS RGA ---- */
    { navn:"Alex Molenaar", lag:"CRR", land:"Nederland", alder:26, rolle:"Puncheur / etappejeger", nr:224, foto:"",
    ...
    { navn:"Fernando Gaviria", lag:"CRR", land:"Colombia", alder:31, rolle:"Spurt", nr:221, foto:"",
    ...
    { navn:"Clint Berwick", lag:"CRR", land:"Australia", alder:29, rolle:"Allrounder / hjelper", nr:223, foto:"",
      meritter:"Solid hjelper",
      form:"Bidragsyter for Caja Rural.",
      historie:"Australsk allrounder og hjelper." },
    { navn:"Simone Oldani", lag:"CRR", land:"Italia", alder:27, rolle:"Spurt / puncheur", nr:226, foto:"",
      meritter:"Etappeseirer",
      form:"Italiensk spurter/puncheur for Caja Rural.",
      historie:"Sterk på kuperte avslutninger." },
    { navn:"Joel Nicolau", lag:"CRR", land:"Spania", alder:26, rolle:"Spurt / puncheur", nr:225, foto:"",
    ...
    { navn:"Jakub Otruba", lag:"CRR", land:"Tsjekkia", alder:27, rolle:"Hjelper / allrounder", nr:227, foto:"",
      meritter:"Allrounder",
    ...
    { navn:"José Félix Parra", lag:"CRR", land:"Spania", alder:26, rolle:"Klatrer / hjelper", nr:228, foto:"",
