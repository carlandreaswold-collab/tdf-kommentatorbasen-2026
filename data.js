...
const TDF_DATA = {
  ...
  lag: [
    ...
    { kort:"APT", navn:"Alpecin-Premier Tech", land:"Belgia", farger:["#e6007e","#1d1d1b","#ffffff"],
      ...
      ryttere:"van der Poel, Philipsen, Verstrynge, Rickaert, Marsman, Debruyne",
      notat:"VdP + Philipsen = to av verdens beste spurter/klassikerryttere. VdP jakter Montjuïc og Montmartre. NB: Kaden Groves er IKKE med på TdF-laget — erstattet av Tim Marsman og Ramses Debruyne. APT er ett av to lag som ikke er fullt bemannet.",
    ...
    { kort:"PQ3", navn:"Pinarello-Q36.5", land:"Storbr.", farger:["#1d1d1b","#3da9fc","#ffffff"],
      ...
      ryttere:"Pidcock, Wright, Hermans Q., Van Moer, Azparren",
